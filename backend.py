...
def insert(wo_id,lm_user,op,count,start_time,end_time,lm_time,ma_id):
    conn = pymssql.connect(host='192.168.0.56',
                       user='sa',
                       password='1234',
...
def detect_working(wo_id,ma_id,lm_user,op,count):
    global machine_flag
    #suspend_time = 0
